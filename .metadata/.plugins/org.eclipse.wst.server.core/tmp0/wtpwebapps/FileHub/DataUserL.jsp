...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
<h1><span style="color:"blue"">Multi Authority Cloud Storage</span></h1>      </div>
      <div class="menu_nav">
        <ul>
...
<input class="inputtype1" type="text" name="username" placeholder="Enter Username" required=""/>
  ...
  <button class="editedbutton" type="submit" style="margin-left:50px; ">login</button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="DataUserR.jsp">New user click here</a> 
  </form>
