...
public final class UserRequestFilesView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h1><span style=\"color:#2D66F1\">Multi Authority Cloud Storage</span></h1>\r\n");
      out.write("      </div>\r\n");
      ...
      out.write("\t\t\t\t<li class=\"active\"><a href=\"UserRequestFilesView.jsp\">Requested Files</a></li>\r\n");
      ...
      out.write("  \r\n");
      out.write("  \r\n");
      out.write("<!-- <div style=\"margin-left:400px;height:auto;\"> -->\r\n");
      out.write("\r\n");
...
ps=con.prepareStatement("SELECT * FROM `cc10`.`requesttable`where RequestUser='"+username+"'");
rs=ps.executeQuery();
while(rs.next())
{
