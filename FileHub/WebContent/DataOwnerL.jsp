...
<h1><span style="color:#2D66F1">Multi Authority Cloud Storage</span></h1>      </div>
      <div class="menu_nav">
        <ul>
				...
				<li class="active"><a href="DataOwnerL.jsp">Data owner</a></li>
  ...
  <form action="LoginServletO" method="post">
 <input class="inputtype1" type="text" name="username" placeholder="Enter Username" required=""/>
  ...
  <button class="editedbutton" type="submit" style="margin-left:50px; ">login</button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="DataOwnerR.jsp">New user click here</a> 
  </form>
