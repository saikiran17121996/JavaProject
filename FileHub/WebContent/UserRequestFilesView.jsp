...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><span style="color:#2D66F1">Multi Authority Cloud Storage</span></h1>
      </div>
      <div class="menu_nav">
        <ul>
           <li><a href="UserHome.jsp">Data user</a></li>
				...
				<li class="active"><a href="UserRequestFilesView.jsp">Requested Files</a></li>
...
<!-- <div style="margin-left:400px;height:auto;"> -->

<form action="UserRequestServer" method="post">
